...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data_dir", type=str, default="/data/hy_data/BARTNER-main/data/share2013", help="data dir")
    parser.add_argument("--bert_config_dir", type=str, default="facebook/bart-large", help="bert config dir")
